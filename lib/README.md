...
```bash
go get github.com/kubrickcode/specvital/lib
```
...
import (
    ...
    _ "github.com/kubrickcode/specvital/lib/parser/strategies/all" // All frameworks
)
...
```go
import "github.com/kubrickcode/specvital/lib/crypto"
...
```go
import "github.com/kubrickcode/specvital/lib/source"
