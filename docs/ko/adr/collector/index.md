...
| 05  | [Worker-Scheduler 프로세스 분리](./05-worker-scheduler-separation.md)           | 2024-12-18 |
...
| 08  | [External Repository ID 기반 데이터 무결성](./08-external-repo-id-integrity.md) | 2024-12-22 |
