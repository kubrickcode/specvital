              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Distributed Lock Concurrency", link: "/en/adr/collector/04-distributed-lock-scheduler-concurrency" },
                    { text: "OAuth Token Degradation", link: "/en/adr/collector/05-oauth-token-graceful-degradation" },
                    { text: "Asynq slog Adapter", link: "/en/adr/collector/06-asynq-slog-adapter" },
                    { text: "Worker-Scheduler Separation", link: "/en/adr/collector/07-worker-scheduler-separation" },
                    { text: "Semaphore Clone Concurrency", link: "/en/adr/collector/08-semaphore-clone-concurrency" },
                    { text: "Repository Pattern", link: "/en/adr/collector/09-repository-pattern" },
                  ],
                },
                {
                  text: "Web",
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "분산 락 동시성 제어", link: "/ko/adr/collector/04-distributed-lock-scheduler-concurrency" },
                    { text: "OAuth 토큰 Degradation", link: "/ko/adr/collector/05-oauth-token-graceful-degradation" },
                    { text: "Asynq slog 어댑터", link: "/ko/adr/collector/06-asynq-slog-adapter" },
                    { text: "Worker-Scheduler 분리", link: "/ko/adr/collector/07-worker-scheduler-separation" },
                    { text: "Semaphore Clone 동시성", link: "/ko/adr/collector/08-semaphore-clone-concurrency" },
                    { text: "Repository 패턴", link: "/ko/adr/collector/09-repository-pattern" },
                  ],
                },
                {
                  text: "Web",
