...
func (m *mockStatusRepository) GetAnalysisTestCount(_ context.Context, _ string) (int, error) {
	return 100, nil
}
...
func (m *mockStatusRepository) GetSpecDocumentByRepositoryAndDocumentId(_ context.Context, _, _, _, _ string) (*entity.RepoSpecDocument, error) {
	return nil, nil
}
...
func (m *mockStatusRepository) GetCachePredictionData(_ context.Context, _, _, _ string) (*entity.CachePredictionData, error) {
	return nil, nil
}
func (m *mockStatusRepository) GetCurrentAnalysisTestCount(_ context.Context, _ string) (int, error) {
	return 0, nil
}
