...
import (
	...
	analyzerport "github.com/kubrickcode/specvital/apps/web/backend/modules/analyzer/domain/port"
	specviewport "github.com/kubrickcode/specvital/apps/web/backend/modules/spec-view/domain/port"
