...
import (
	...
	"github.com/kubrickcode/specvital/apps/web/backend/common/docs"
	"github.com/kubrickcode/specvital/apps/web/backend/common/health"
	...
	"github.com/kubrickcode/specvital/apps/web/backend/common/ratelimit"
	"github.com/kubrickcode/specvital/apps/web/backend/internal/api"
	"github.com/kubrickcode/specvital/apps/web/backend/internal/client"
	"github.com/kubrickcode/specvital/apps/web/backend/internal/db"
	"github.com/kubrickcode/specvital/apps/web/backend/internal/infra"
	analyzeradapter "github.com/kubrickcode/specvital/apps/web/backend/modules/analyzer/adapter"
	analyzerhandler "github.com/kubrickcode/specvital/apps/web/backend/modules/analyzer/handler"
	analyzerusecase "github.com/kubrickcode/specvital/apps/web/backend/modules/analyzer/usecase"
	authadapter "github.com/kubrickcode/specvital/apps/web/backend/modules/auth/adapter"
	authhandler "github.com/kubrickcode/specvital/apps/web/backend/modules/auth/handler"
	authusecase "github.com/kubrickcode/specvital/apps/web/backend/modules/auth/usecase"
	ghappadapter "github.com/kubrickcode/specvital/apps/web/backend/modules/github-app/adapter"
	ghapphandler "github.com/kubrickcode/specvital/apps/web/backend/modules/github-app/handler"
	ghappusecase "github.com/kubrickcode/specvital/apps/web/backend/modules/github-app/usecase"
	githubadapter "github.com/kubrickcode/specvital/apps/web/backend/modules/github/adapter"
	githubhandler "github.com/kubrickcode/specvital/apps/web/backend/modules/github/handler"
	githubusecase "github.com/kubrickcode/specvital/apps/web/backend/modules/github/usecase"
	useradapter "github.com/kubrickcode/specvital/apps/web/backend/modules/user/adapter"
	userhandler "github.com/kubrickcode/specvital/apps/web/backend/modules/user/handler"
	activetaskuc "github.com/kubrickcode/specvital/apps/web/backend/modules/user/usecase/activetask"
	bookmarkuc "github.com/kubrickcode/specvital/apps/web/backend/modules/user/usecase/bookmark"
	historyuc "github.com/kubrickcode/specvital/apps/web/backend/modules/user/usecase/history"

	specviewadapter "github.com/kubrickcode/specvital/apps/web/backend/modules/spec-view/adapter"
	specviewhandler "github.com/kubrickcode/specvital/apps/web/backend/modules/spec-view/handler"
	specviewusecase "github.com/kubrickcode/specvital/apps/web/backend/modules/spec-view/usecase"
	subscriptionadapter "github.com/kubrickcode/specvital/apps/web/backend/modules/subscription/adapter"
	subscriptionhandler "github.com/kubrickcode/specvital/apps/web/backend/modules/subscription/handler"
	subscriptionusecase "github.com/kubrickcode/specvital/apps/web/backend/modules/subscription/usecase"
	usageadapter "github.com/kubrickcode/specvital/apps/web/backend/modules/usage/adapter"
	usagehandler "github.com/kubrickcode/specvital/apps/web/backend/modules/usage/handler"
	usageusecase "github.com/kubrickcode/specvital/apps/web/backend/modules/usage/usecase"
)
