...
export interface components {
  schemas: {
    ...
    SpecDocumentResponse:
      | components["schemas"]["SpecDocumentCompleted"]
      | components["schemas"]["SpecDocumentGenerating"];
    ...
    RepoSpecDocumentResponse:
      | components["schemas"]["RepoSpecDocumentCompleted"]
      | components["schemas"]["RepoSpecDocumentEmpty"];
